...
const Number_1 = __importDefault(require("../../models/Number"));
const logger_1 = require("../../config/logger");
const appError_1 = __importDefault(require("../../utils/appError"));
class NumberStorage {
    constructor() {
        this.scope = 'storage.number';
    }
    find(postLimit, postPage, status, search) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Number_1.default.aggregate([
    ...
    findOne(query) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Number_1.default.findOne(Object.assign({}, query));
                if (!dbObj) {
                    logger_1.logger.warn(`${this.scope}.get failed to findOne`);
                    throw new appError_1.default(404, 'number_404');
                }
                return dbObj;
            }
            catch (error) {
    ...
    create(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Number_1.default.create(payload);
                return dbObj;
            }
            catch (error) {
    ...
    update(id, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Number_1.default.findByIdAndUpdate(id, payload, {
                    new: true
                });
                if (!dbObj) {
    ...
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Number_1.default.findByIdAndDelete(id);
                if (!dbObj) {
