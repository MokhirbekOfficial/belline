...
class NumberValidator {
    constructor() {
        this.createSchema = joi_1.default.object({
            ...
            monthyPrice: joi_1.default.number().required(),
            setupPrice: joi_1.default.number().required(),
            currency: joi_1.default.string().required()
        });
        this.updateSchema = joi_1.default.object({
            _id: joi_1.default.forbidden(),
            value: joi_1.default.string(),
            monthyPrice: joi_1.default.number(),
            setupPrice: joi_1.default.number(),
            currency: joi_1.default.string(),
            status: joi_1.default.string().valid('active', 'sold')
        });
